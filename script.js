...
const translations = {
    ru: {
        ...
        h2: `друзья и близкие,Приглашаем вас <br> разделить с нами  
             радость и отпраздновать <br> наш самый счастливый день — свадьбу!<br>`,
        ...
        name: "Имя Фамилия:",
        name1: "Со стороны Жениха",
        name2: "Со стороны Невесты",
        r: "Сможете ли вы присутствовать?",
        yes: `Да, буду присутствовать <style>
        .rad+label {
            font-size: 12px;
        }
                    </style>`,
        no: "Нет, не буду присутствовать",
